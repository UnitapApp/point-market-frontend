...
const Header = () => {
  return (
    <div className="header w-full h-[202px] bg-gray20 rounded-2xl bg-[url('/assets/images/pass/bg-header.svg')]  flex flex-col gap-5 justify-end items-start overflow-hidden relative pl-6 pb-5 mb-4">
